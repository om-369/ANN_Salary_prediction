...
input_data = pd.DataFrame({
    ...
    'Gender': [label_encoder_gender.transform([gender])[0]],  # Corrected to 'Gender'
    'Age': [age],
    'Tenure': [tenure],
    'Balance': [balance],
...
# Ensure the order of columns matches the scaler's fit
...
input_data_combined = input_data_combined[expected_columns]
